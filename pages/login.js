...
export default class LoginPage {
    ...
    setupEventListeners() {
        ...
        if (!googleSignInBtn) {
            console.error('[LoginPage] googleSignInBtn not found in DOM');
        }
        ...
        if (googleSignInBtn) {
            googleSignInBtn.addEventListener('click', () => {
                console.log('[LoginPage] googleSignInBtn click event');
    ...
    async handleGoogleLogin() {
        if (this.isLoading) {
            console.log('[LoginPage] Already loading, abort Google login');
            return;
        }
        this.setLoading(true);
        this.hideError();
        try {
            ...
            console.error('[LoginPage] Error during signInWithGoogle:', err);
            this.showError('Unexpected error during Google login.');
            this.setLoading(false);
        }
    }
